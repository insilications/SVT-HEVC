...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1600026539
mkdir -p clr-build
pushd clr-build
...
%cmake .. -DNATIVE=ON -DBUILD_APP=1 -DBUILD_SHARED_LIBS=OFF -DCMAKE_POSITION_INDEPENDENT_CODE:BOOL=OFF -DSTATIC_LINK_CRT:BOOL=ON
...
export FCFLAGS="${FCFLAGS_GENERATE}"
export LDFLAGS="${LDFLAGS_GENERATE}"
%cmake .. -DNATIVE=ON -DBUILD_APP=1 -DBUILD_SHARED_LIBS=ON -DCMAKE_POSITION_INDEPENDENT_CODE:BOOL=OFF -DSTATIC_LINK_CRT:BOOL=ON
make  %{?_smp_mflags}  V=1 VERBOSE=1
